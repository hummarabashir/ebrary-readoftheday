...
const ebooks = {
  ebook1: {
    ...
    desc: "The Foreign Service Assignment Notebook (FSAN) offers invaluable information and guidance on various aspects of preparing for an international move.",
    price: 1724,
    status: "available",
  },
